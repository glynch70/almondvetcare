...
const initialTeam = [
  {
    ...
    bio: "Graduated in 2015, specialising in small animal medicine and surgery.",
  ...
  },
  {
    ...
    name: "Lisa Elgie",
    role: "Co-Founder & Veterinarian",
    bio: "Graduated in 2016, specialising in emergency and critical care with a passion for feline medicine.",
